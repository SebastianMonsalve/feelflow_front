...
const LoginPage = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center relative">
      <div className="absolute top-1 left-1" onClick={() => navigate(-1)}>
        <i className="fal fa-long-arrow-left text-text-contrast p-5 text-3xl cursor-pointer" />
      </div>
      <div className="w-full p-8 lg:w-4/5">
        <h2 className="text-4xl font-bold text-text-contrast">
          Bienvenido de nuevo
        </h2>
        <p className="text-text-contrast text-lg mt-4 mb-8">
        ...
        <form action="" className="flex flex-col gap-4">
          ...
          <div className="flex flex-col lg:flex-row gap-2 w-full items-center justify-center mt-8">
            ...
            <Link className="text-primary hover:text-primary-hover text-lg font-bold cursor-pointer whitespace-nowrap">
              Recuperarla aquí
            </Link>
          </div>
          <div className="flex flex-col lg:flex-row gap-2 w-full items-center justify-center mt-2">
            ...
            <Link
              className="text-primary hover:text-primary-hover text-lg font-bold cursor-pointer whitespace-nowrap"
              to="/register"
            >
              Regístrate gratis.
            </Link>
